...
const EstampadosDetail = () => {
    ...
    const bgColors = ['bg-black', 'bg-white', 'bg-gray-200','bg-gray-300','bg-gray-400','bg-gray-500','bg-gray-600','bg-gray-700','bg-gray-800','bg-gray-900',
  ...
  const fillStrokeColors = [
    '#0000000', '#ffffff','#E5E7EB', '#D1D5DB', '#9CA3AF', '#6B7280', '#4B5563', '#374151', '#1F2937', '#111827'
    , '#FEF2F2', '#FEE2E2', '#FECACA', '#FCA5A5', '#F87171', '#EF4444', '#DC2626', '#B91C1C', '#991B1B', '#7F1D1D'
    , '#FFFBEB', '#FEF3C7', '#FDE68A',  '#FCD34D', '#DBBF24','#F59E0B', '#D97706', '#B45309', '#92400E', '#78350F'
    ...
    , '#F5F3FF', '#EDE8FE', '#DDD6FE', '#C4B5FD', '#A78BFA', '#8B5CF6', '#7C3AED', '#6D28D9', '#5B21B6', '#4C1D95'
    , '#FDF2F8', '#FCE7F3', '#FBCFE8', '#F9A8D4', '#F472B6', '#EC4899', '#DB2777', '#B3185D', '#9D174D', '#831843'
  ]
