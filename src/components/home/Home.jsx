...
const Home = () => {
  return (
    ...
    <div className="mt-24 flex flex-col items-center align-center">
      ...
      <Link  to={'/Nosotros'} layout className="card w-96 mx-10 h-96 shadow-lg shadow-primary/20">
        ...
        <Link to={'/estampados'} layout className="card w-96 mx-10 h-96 shadow-lg shadow-primary/20">
        <div className='flex flex-col items-center justify-center h-4/6' >
        ...
        <Link to={'/Contacto'} layout className="card w-96 h-96 mx-10 shadow-lg shadow-primary/20">
        <div className='flex flex-col items-center justify-center h-4/6' >
